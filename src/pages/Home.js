    ...
    <>
      ...
      >
        ...
        <Association
          ...
          description={[
            "ASASOA France Madagascar a créé un centre de formation informatique pour des jeunes à Antananarivo, qui propose aux jeunes des cours d'informatique, de langues et une formation de guide écotouristique. Pour promouvoir le chocolat d'exception malgache (sacré meilleur chocolat du monde en 2017, mais gravement menacé en raison de sa trop faible production face aux besoins internationaux et concurrents de Côte d'Ivoire, de Colombie et surtout des pays asiatiques, La Route du Chocolat invite les touristes à venir découvrir Madagascar.",
          ]}
          link=""
        />
        <Association
        ...
        <Association
          ...
          description={[
            "Hubert Gouin-Enfance et Cancer soutient depuis près de 20 ans la recherche en oncologie pédiatrique, pour que des enfants aient accès à des traitements mieux ciblés, moins invasifs et mieux différenciés. L'association qui soutint financièrement différents projets sélectionnés par son comité scientifique, a été associée à 3 découvertes majeures dans la compréhension du neuroblastome, cancer du jeune enfant présentant un faible pronostic vital de l'ordre de 40%. En 2017, elle a renouvelé son soutien à l'Institut Curie pour 3 projets de recherche prometteurs pour mieux comprendre la genèse des cancers de l'enfant.",
        ...
        <Association
          ...
          name="SEM"
          description={[
            "Soutien de l'Enfant Malade (SEM) a été créée en 2001 par des soignants du service de réanimation infantile et rééducation neuro-respiratoire de l'Hôpital Raymond Poincaré de Garches. Conscients des spécificités du service, de la durée d'hospitalisation des enfants (certains enfants y passent toute leur enfance et leur adolescence), et surtout de la lourdeur des pathologies prises en charge, l'équipe s'attache à améliorer le cadre de vie à l'hôpital, pour un meilleur moral des jeunes patients et de leur famille. L'association a étendu son action à tout le service de pédiatrie de l'hôpital (hôpital de jour, école au sein de l'hôpital…). Les fonds proviennent des ventes de Noël, dons d'entreprise et d'associations diverses.",
        ...
        <Association
          ...
          name="Slovensko"
          description={[
            "Slovensko promeut la culture slovaque en France, mène des actions de jumelage avec la ville slovaque de Brezno et organise des animations folkloriques (l'ensemble Nadeje participe chaque année à divers festivals folkloriques et évènements culturels, en France et en Slovaquie.",
          ]}
          link=""
        />
        <Association
